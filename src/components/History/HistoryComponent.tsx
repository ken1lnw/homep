  ...
  const raw =    [
    {
      ...
      children: (
        ...
        >
          ...
          <p className="">
            Establishment of TYC BROTHER INDUSTRIAL CO., LTD.
          </p>

          <p>
            The original TYC logo was comprised of a circular frame logo
            that symbolizes harmony within the industry as well as within
            the company’s corporate culture and attitude towards
            people.Bringing Happiness, Convenience, Hope & Encouragement
            to others.
          </p>
...

    {
      ...
      children: (
        ...
        >
          ...
          <p>
            Established 1st manufacturing plant in China called CHANGZHOU
            TAMAU AUTO LAMP.
          </p>

          <p>
            Established GENERA CORPORATION’s second U.S. Sales &
            Distribution Center (formerly Land Force Corp.) in New Jersey.
          </p>
        </motion.div>
      ),
    },

    {
      ...
      children: (
        ...
        >
          ...
          <p>
            Initial Public Offering listed in Taiwan Securities Exchange.
          </p>
        </motion.div>
      ),
    },

    {
      ...
      children: (
        ...
        className="space-y-5">
          ...
          <p>
            In 1998 the new sun rays design shows a clear and neat
            conveying TYC‘s goal of Lighting up the world!
          </p>
...

    {
      ...
      children: (
        ...
        className="space-y-5">
          ...
          <p>
            Acquired TAIWAN STANLEY INDUSTRIAL CO., LTD., now known as
...

    {
      ...
      children: (
        ...
        className="space-y-5">
          ...
          <p>
            Entered into JV cooperation with China HARBIN HAFEI INDUSTRY
            CO., LTD. and formed HARBIN HAXING MOTOR COMPONENTS CO., LTD.
            in China.{" "}
          </p>

          <p>
            Established CHANGZHOU TAMOU PRECISION INDUSTRIAL CO. LTD., for
            plastic tooling design, development and manufacturing in
            China.
          </p>
        </motion.div>
      ),
...

    {
      ...
      children: (
        ...
        className="space-y-5">
          ...
          <p>
            Built and moved manufacturing production plant facilities to
            Tainan Tech Park.
          </p>

          <p>
            Established Europe Central Sales & Distribution Warehouse
            called TYC EUROPE B.V. in Almere, the Netherlands.
          </p>
        </motion.div>
      ),
    },

    {
      ...
      children: (
        ...
        className="space-y-5">
          ...
          <p>
            Entered into a JV cooperation with China FIRST AUTO WORKS and
            formed CHANGCHUN E-CHI SHI HUAN.
          </p>
        </motion.div>
      ),
    },
      ...
      children: (
        ...
        viewport={{ once: true }}
         ...
         className="space-y-5">
          ...
          <p>
            Visteon Corporation USA purchased shares in CHANGZHOU TAMAU
            AUTO LAMPS which is then renamed VISTEON TYC AUTO LAMPS CO.,
            LTD.
          </p>
        </motion.div>
      ),
...

    {
      ...
      children: (
        ...
        className="space-y-5">
          ...
          <p>
            Increased share holding of CHANG CHUN E CHI SHI HUAN to 100%
            and renamed it CHANG CHUN SPARX AUTO LAMPS CO., LTD.
          </p>
        </motion.div>
      ),
    },

    {
      ...
      children: (
        ...
        className="space-y-5 ">
          ...
          <p>
            Established KUN SHAN TYC HIGH PERFORMANCE LIGHTING TECH CO.,
            LTD in China.
          </p>
        </motion.div>
      ),
...

    {
      ...
      children: (
        ...
        className="space-y-5 mb-20">
          ...
          <p>
            The evolution of the TYC logo into a single form with
            corporate Blue color, conveys the value of pursuing “Light,
...

    {
      ...
      children: (
        ...
        className="space-y-5">
          ...
          <p>
            Changed the name of VISTEON TYC AUTO LAMPS CO. to VARROC TYC
            AUTO LAMPS CO. after Varroc Group India purchased Visteon’s
            shareholding.
          </p>
        </motion.div>
      ),
...

    {
      ...
      children: (
        ...
        className="space-y-5">
          ...
          <p>
            Opening of second manufacturing plant of VARROC TYC AUTO LAMPS
            CO. in Chonqing, China.
          </p>
        </motion.div>
      ),
    },

    {
      ...
      children: (
        ...
        className="space-y-5">
          ...
          <p>
            Started Phase 3 Tainan Tech Park Assembly Plant Operation.{" "}
          </p>
        </motion.div>
      ),
    },
