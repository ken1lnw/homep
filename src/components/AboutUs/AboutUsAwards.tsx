          ...
          >
            ...
            <SwiperSlide>
              <div className="flex flex-col items-center relative group">
                ...
                />
                <div className="absolute top-0  h-full flex items-center justify-center bg-black/80 bg-opacity-50 text-blue-500 font-semibold p-1 text-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
