      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 flex items-center xl:w-1/2 xl:top-1/2 xl:left-1/2 xl:transform  xl:-translate-x-1/2  xl:-translate-y-1/2 px-6 text-white">
         ...
         <motion.div
          ...
          For Replacement Aftermarket Automotive Spare Parts , With our comprehensive selection of aftermarket spare parts, <br/> we provide a one-stop-shop premium service to our customers.
